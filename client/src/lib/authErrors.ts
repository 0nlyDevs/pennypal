...
export const extractErrorMessage = (err: unknown, fallback = 'Unexpected error'): string => {
...
export type AuthAction = 'login' | 'signup' | 'logout' | 'me';

export const toFriendlyAuthMessage = (err: unknown, action: AuthAction): string => {
